---
Number: 69
Title: Безопасность контейнеров, атака на пакеты, засолка паролей
PublishDate: 2023-04-02T21:17:09Z
Authors:
  - Анатолий Кулаков
  - Игорь Лабутин
...
Topics:
  ...
  - Subject: Attack to .NET packages with malicious-code
    Timestamp: 00:13:50
    Links:
      - https://jfrog.com/blog/attackers-are-starting-to-target-net-developers-with-malicious-code-nuget-packages/

  - Subject: Secure your .NET apps with rootless Linux Containers
    Timestamp: 00:32:46
    Links:
      - https://devblogs.microsoft.com/dotnet/securing-containers-with-rootless/

  - Subject: Hashing and Salting Passwords in C# – Best Practices
    Timestamp: 00:43:50
    Links:
      - https://code-maze.com/csharp-hashing-salting-passwords-best-practices/

  - Subject: Universally Unique Lexicographically Sortable Identifier
    Timestamp: 01:04:50
    Links:
  ...
  - Subject: Maximizing the power of logs as your application scales
    Timestamp: 01:27:42
    Links:
