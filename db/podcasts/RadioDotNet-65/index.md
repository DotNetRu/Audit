---
Number: 65
Title: Подсматриваем за C# 12, ускоряем консоль, слушаем http запросы
...
Topics:
  ...
  - Subject: Slaying Zombie 'No Repro' Crashes with Infer#
    Timestamp: 00:27:25
    Links:
      - https://devblogs.microsoft.com/dotnet/slaying-zombie-no-repo-crashes-with-infersharp/

  - Subject: Visual Studio 2022 17.5 Preview 3
    Timestamp: 00:34:00
    Links:
  ...
  - Subject: Rider and Reshaper 2023.1 roadmap
    Timestamp: 00:40:50
    Links:
  ...
  - Subject: Detecting breaking changes between two versions of a NuGet package
    Timestamp: 00:46:40
    Links:
      - https://www.meziantou.net/detecting-breaking-changes-between-two-versions-of-a-nuget-package-at-packaging.htm

  - Subject: Database Command Batching in .NET 6
    Timestamp: 00:54:40
    Links:
      - https://www.infoq.com/news/2022/06/Database-Command-Batching/

  - Subject: Observing all http requests in a .NET application
    Timestamp: 01:00:30
    Links:
  ...
  - Subject: Быстрый консольный ввод на .NET
    Timestamp: 01:13:45
    Links:
      - https://habr.com/ru/post/705834/

  - Subject: Building a custom Test Framework with xUnit
    Timestamp: 01:24:35
    Links:
